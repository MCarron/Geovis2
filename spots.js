...
"features": [
    {
      ...
      "properties": {
        ...
        "Type_voies": "Couennes",
        "nbr_voies": 20,
        "description": "Très jolie petite dalle située à 15 minutes à pied de Verschiez. Le secteur est composé d'une quinzaine de voies orientées sud, dont la longueur varie entre 15m et 22m.",
    ...
    },
    {
      ...
      "properties": {
        ...
        "Type_voies": "Couennes",
        "nbr_voies": 8,
        "description": "Très jolie petite dalle située à 15 minutes à pied de Verschiez. Le secteur est petit et se compose uniquement de 6-7 voies orientées sud. Le spot convient donc plus pour une soirée de semaine où l'affluence sera moindre.",
    ...
    },
    {
      ...
      "properties": {
        ...
        "Type_voies": "Couennes",
        "nbr_voies": 3,
        "description": "Joli secteur de grimpe situé à 5 minutes à pied du parking. Le secteur est composé d'une vingtaine de voies relativement engagées. Il est idéal pour l'été car orienté ouest / nord-ouest, ce qui permet de se mettre à l'abri les journées de forte chaleur.",
    ...
    },
    {
      ...
      "properties": {
        ...
        "Type_voies": "Couennes",
        "nbr_voies": 60,
        "description":"Le magnifique secteur de Drapel se situe juste en dessus d'Yvorne et surplombe la plaine du Rhône. Le spot est divisé en plusieurs secteurs qui composent plus d'une centaine de voies. Il convient donc parfaitement pour les journées de week-end à forte affluence. L'approche se fait le long d'un sentier partant du parking (environ 20 minutes à pied).",
    ...
    },
    {
      ...
      "properties": {
        ...
        "Type_voies": "Couennes",
        "nbr_voies": 70,
        "description": "Situé à plus de 1000m d'altitude, le spot du Roc de Veyges est un endroit idéal pour grimper avec une magnifique vue surplombant la plaine du Rhône. Le spot est divisé en trois secteurs et propose plus de cinquante voies de tous les niveaux. Attention : l'approche se fait le long d'un sentier étroit.",
    ...
    },
    {
      ...
      "properties": {
        ...
        "Type_voies": "Couennes",
        "nbr_voies": 56,
        "description": "Le secteur du Jardin Perdu est un secteur engagé avec un niveau de difficulté commençant avec du '6a'. Le spot propose ainsi une vingtaine de voies sur un calcaire relativement peu marqué. Ce dernier est situé à plus de 1000m d'altitude et se pratique donc uniquement en été.",
    ...
    },
    {
      ...
      "properties": {
        ...
        "Type_voies": "Couennes",
        "nbr_voies": 80,
        "description": "Ce spot est apprécié pour les initiations et les sorties en famille en raison en son accessibilité (situé à 3 minutes de marche du parking le long d'un sentier) et des voies relativement simples qu'on y trouve. Le secteur offre tout de même de jolis défis pour tous les niveaux. Attention les journées de week-end le spot est souvent très occupé.",
    ...
    },
    {
      ...
      "properties": {
        ...
        "Type_voies": "Couennes",
        "nbr_voies": 45,
        "description":"Ce secteur situé en plaine chablaisienne offre de nombreuses voies de tous les niveaux. Ce secteur est orienté sud-est et est idéal pour les chaudes journées d'été en raison de la protection qu'offrent les arbres. Attention aux chutes de pierres qui sont fréquentes dans ce secteur.",
    ...
    },
    {
      ...
      "properties": {
        ...
        "nbr_voies": 23,
        "description":"Le site du Scex des Nombrieux se situe à plus de 1500m d'altitude et requiert une bonne heure de marche pour y accéder. Le spot est relativement engagé et demande un niveau de grimpe déjà avancé. Attention, voies de plusieurs longueurs et parois parfois mal équipées.",
    ...
    },
    {
      ...
      "properties": {
        ...
        "Type_voies": "Salle",
        "nbr_voies": 250,
        "description":"La salle a ouvert ses portes fin 2019 et propose désormais un complexe de plus de 1000m carrés qui permet de grimper tant à l'intérieur qu'à l'extérieur. L'ambiance de la salle est magique et il est vivement recommandé de s'arrêter boire une bière à la sortie pour parler de sa session en groupe!",
    ...
    },
    {
      ...
      "properties": {
        ...
        "Type_voies": "Couennes",
        "nbr_voies": 15,
        "description": "Le site de grimpe de Planpraz, situé sur les hauts de Leysin, est un lieu réservé aux grimpeurs de bon niveau. Le spot offre une vingtaine de voies de type divers, dont la hauteur maximum est de 18m. Attention: une via ferrata passe le long des voies, il faut donc faire attention à son équipement et celui des autres.",
    ...
    },
    {
      ...
      "properties": {
        ...
        "Type_voies": "Longues voies et Couennes",
        "nbr_voies": 8,
        "description":"La région de Leysin offre des possibilités de grimpe absolument exceptionnelles et est aujourd'hui connu mondialement. Sur l'ensemble du secteur, on retrouve plus de 800 voies qui sont sécurisées et vérifiées chaque année.",
        "img" : "<img src='img/leysin.jpg' alt='maptime logo gif' width='350px' height='250px'/>",
        "diff": "Tous types de difficultés",
      },
      "geometry": {
        "type": "Point",
