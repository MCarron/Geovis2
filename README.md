...
L'extrait présenté ci-dessous montre à quoi resemble notre fichier GeoJSON. Nous pouvons voir que chaque spots de grimpe est associé à des coordonées géographique précises. De plus, nous pouvons également voir que chacun des spots est associé à un certain nombre de variable qui ont été définient par nous même comme expliqué ci-dessus. 
